...
How to use
----------
* Prepare the OTA xml file. Use this [template](https://raw.githubusercontent.com/AOSP-RRO/platform_packages_apps_OTA/marshmallow/example_ota.xml).
...
* Adjust the OTA configuration according to your build name on how should OTA parse the version
...
* Find a key in build.prop that represents your device name and set it in the "device_name"
  * OTA will search this device name in the OTA xml file
...
<img alt="Screenshot"
   ...
   src="https://raw.githubusercontent.com/SlimSaber/packages_apps_OTA/lp5.0/screenshots/Screenshot_20150505_1317.png" />
